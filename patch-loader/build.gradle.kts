...
android {
    ...
    namespace = "org.IamWan.Zpatch.loader"
}
...
androidComponents.onVariants { variant ->
    ...
    task<Copy>("copyDex$variantCapped") {
        ...
        into("${rootProject.projectDir}/out/assets/${variant.name}/zpatch")
    }
    ...
    task<Copy>("copySo$variantCapped") {
        ...
        from(
            fileTree(
                ...
                "include" to listOf("**/libzpatch.so")
            )
        )
        into("${rootProject.projectDir}/out/assets/${variant.name}/zpatch/so")
    }
